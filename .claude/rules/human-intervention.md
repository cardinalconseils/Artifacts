...
Triggers: interactive login, installing a tool, opening a URL to authenticate, copying an API key, starting a local server.
...
Triggers: architectural choice with real trade-offs, ambiguous user intent where guessing wrong wastes work, explicit user decision points in a lifecycle.
...
Triggers: a next step the user might not have thought of, a better approach to what they just did.
